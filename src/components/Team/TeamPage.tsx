...
const teamSections: TeamSection[] = [
  {
    ...
    imageSrc: "/images/teams/MechTeam.jpg",
  ...
  },
  {
    ...
    imageSrc: "/images/teams/ElectricalTeam.png",
  ...
  },
  {
    ...
    imageSrc: "/images/teams/SoftwareTeam.png",
  ...
  },
  {
    ...
    imageSrc: "/images/teams/ScienceTeam.jpg",
...
const TeamPage: React.FC = () => {
  ...
  const expandedTeam = teamSections.find((section) => section.id === expandedTeamId);
  ...
  return (
    <div className="bg-black text-white py-16 relative min-h-screen">
      ...
      <div className="container mx-auto px-4 text-center mb-12">
        <h1 className="text-4xl sm:text-5xl font-bold mb-4 tracking-wide">Meet Our Team</h1>
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12">
        {teamSections.map((section) => (
          ...
          >
            ...
            <div className="p-6">
              <h2 className="text-2xl font-semibold mb-1 text-[#E63946]">{section.title}</h2>
              <h3 className="text-lg font-medium mb-3 text-gray-300">{section.subtitle}</h3>
        ...
        >
          ...
          >
            ...
            <div className="p-8 overflow-y-auto no-scrollbar flex-1">
              <h2 id="modal-title" className="text-3xl font-bold mb-2 text-[#E63946]">
                {expandedTeam.title}
              </h2>
              <h3 className="text-xl mb-4 text-gray-300">{expandedTeam.subtitle}</h3>
              <p className="text-gray-400 text-lg leading-relaxed mb-4">{expandedTeam.description}</p>
              <p className="text-gray-300 text-base leading-relaxed whitespace-pre-line">{expandedTeam.fullDescription}</p>
            </div>
          </div>
        </div>
      )}
