    ...
    <section className='relative w-full bg-black text-white flex flex-col md:flex-row items-center'>
      ...
      <div className='w-full md:w-1/2 py-12 px-6 md:px-12 lg:px-20 flex flex-col justify-center items-center md:items-start text-center md:text-left'>
        ...
        <p className='mt-6 text-lg md:text-xl text-neutral-300 leading-relaxed'>
          ...
          is the world&apos;s premier robotics competition for university
        ...
        <p className='mt-4 text-lg md:text-xl text-neutral-300 leading-relaxed'>
          Held annually in southern Utah, the challenge brings together 100+
          participants from over a dozen countries. Teams compete to build the
          next generation of Mars rovers, designed to assist astronauts in
          future missions to the Red Planet.
        </p>
        <p className='mt-4 text-lg md:text-xl text-neutral-300 leading-relaxed'>
          The competition pushes boundaries in autonomous navigation, scientific
          discovery, and robotic dexterity, creating real-world space
          exploration scenarios. Students apply engineering, AI, and human-robot
          interaction to drive innovation.
        </p>

        {/* Mission Details Button */}
        <div className='mt-8'>
          <Link
            href='/docs/urc_mission_details.pdf'
            passHref
            download
